...
util::Result<SelectionResult> ChooseSelectionResult(interfaces::Chain& chain, const CAmount& nTargetValue, Groups& groups, const CoinSelectionParams& coin_selection_params)
{
    ...
    if (coin_selection_params.m_enable_algos.test(size_t(SelectionAlgorithm::KNAPSACK))) {
    ...
    if (coin_selection_params.m_enable_algos.test(size_t(SelectionAlgorithm::CG))) {
    ...
    if (coin_selection_params.m_enable_algos.test(size_t(SelectionAlgorithm::SRD))) {
