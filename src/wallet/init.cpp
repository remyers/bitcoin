...
const char * const UTXO_TARGETS_FILENAME = "utxotargets.json";
...
void WalletInit::AddWalletOptions(ArgsManager& argsman) const
{
    ...
    argsman.AddArg("-utxotargetsfile=<file>", strprintf("Specify json file with utxo set targets for coin selection. Relative paths will be prefixed by datadir location. (default: %s)",UTXO_TARGETS_FILENAME), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
